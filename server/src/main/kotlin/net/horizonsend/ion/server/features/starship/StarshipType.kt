...
enum class StarshipType(
	...
	TANKER(
		displayName = "Tanker",
		icon = SidebarIcon.TANKER_ICON.text,
		minSize = 12000,
		maxSize = 16000,
		minLevel = 70,
		containerPercent = 0.045,
		crateLimitMultiplier = 0.9,
		...
		miningLaserTier = 3,
		overridePermission = "ion.ships.override.70",
		balancingSupplier = IonServer.starshipBalancing::tanker
	),
	AI_TANKER(
		displayName = "Tanker",
		icon = SidebarIcon.TANKER_ICON.text,
		...
		miningLaserTier = 3,
		concretePercent = 0.0,
		overridePermission = "ion.ships.ai.tanker",
		balancingSupplier = IonServer.starshipBalancing::aiTanker
	),
	BARGE(
		displayName = "Barge",
